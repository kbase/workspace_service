package Bio::KBase::workspaceService::Service;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::workspaceService::ServiceContext->new(client_ip => $self->_plack_req->address);
...
package Bio::KBase::workspaceService::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::workspaceService::ServiceContext
