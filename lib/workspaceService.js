...
//	var resp = json_call_sync("workspaceService.get_object", [params]);
    ...
    {
	json_call_ajax_async("workspaceService.get_object", [params], 2, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("workspaceService.revert_object", [params]);
    ...
    this.unrevert_object = function(params)
    {
	var resp = json_call_ajax_sync("workspaceService.unrevert_object", [params]);
//	var resp = json_call_sync("workspaceService.unrevert_object", [params]);
        return resp[0];
    }

    this.unrevert_object_async = function(params, _callback, _error_callback)
    {
	json_call_ajax_async("workspaceService.unrevert_object", [params], 1, _callback, _error_callback)
    }
