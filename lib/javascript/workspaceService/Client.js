...
//	var resp = json_call_sync("workspaceService.load_media_from_bio", [params]);
        return resp[0];
    }
...
//	var resp = json_call_sync("workspaceService.import_bio", [params]);
        return resp[0];
    }
...
//	var resp = json_call_sync("workspaceService.import_map", [params]);
        return resp[0];
    }
...
//	var resp = json_call_sync("workspaceService.patch", [params]);
        return resp[0];
    }
