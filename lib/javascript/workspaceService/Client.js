...
//	var resp = json_call_sync("workspaceService.get_objectmeta_by_ref", [params]);
    ...
    this.object_to_html = function(params)
    {
	var resp = json_call_ajax_sync("workspaceService.object_to_html", [params]);
//	var resp = json_call_sync("workspaceService.object_to_html", [params]);
        return resp[0];
    }

    this.object_to_html_async = function(params, _callback, _error_callback)
    {
	json_call_ajax_async("workspaceService.object_to_html", [params], 1, _callback, _error_callback)
    }

    this.objectref_to_html = function(params)
    {
	var resp = json_call_ajax_sync("workspaceService.objectref_to_html", [params]);
//	var resp = json_call_sync("workspaceService.objectref_to_html", [params]);
        return resp[0];
    }

    this.objectref_to_html_async = function(params, _callback, _error_callback)
    {
	json_call_ajax_async("workspaceService.objectref_to_html", [params], 1, _callback, _error_callback)
    }
